package Patent.BackendPatent.security;

import Patent.BackendPatent.security.auth.filtersAndOther.AuthenticationTokenFilter;
import Patent.BackendPatent.security.auth.filtersAndOther.RestAuthenticationEntryPoint;
import Patent.BackendPatent.security.auth.service.JwtUtil;
import Patent.BackendPatent.service.KorisnikService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/patent/downloadPDF/*").permitAll()
                .antMatchers("/api/resenje/downloadPDF/*/*").permitAll()
                ...
                .addFilterBefore(new AuthenticationTokenFilter(tokenUtils, korisnikService),
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/api/security/login","/api/security/register", "/recover/**");
        web.ignoring().antMatchers(HttpMethod.GET,  "/","/api/patent/downloadPDF/*","/api/resenje/downloadPDF/*/*","/api/security/logout", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html",
                "/**/*.css", "/**/*.js", "/recover/**");
