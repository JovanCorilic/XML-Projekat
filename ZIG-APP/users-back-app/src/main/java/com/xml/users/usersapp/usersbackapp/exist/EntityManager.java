package com.xml.users.usersapp.usersbackapp.exist;
...
//			String s = (String) res.getContent();
	...
	public String[] loadAllSubCollections(String collectionUri) throws Exception  {
		...
		try {
			...
			String[] subcol =  col.listResources();
